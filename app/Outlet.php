...
class Outlet extends Model
{
     ...
     */
    protected $fillable = [
        'id_pemda', 'name', 'kode_barang', 'register', 'luas', 'tahun_pengadaan', 'penggunaan', 'harga', 'address', 'keterangan', 'nomor_sertifikat', 'tanggal_sertifikat', 'hak', 'file_path', 'file_photo',  'latitude', 'longitude', 'polygon', 'id_opd', 'nama_opd', 'creator_id',
    ];
    ...
    public function getNameLinkAttribute()
    {
        $title = __('app.show_detail_title', [
            'outlets.' => $this->name, 'type' => __('outlet.outlet'),
        ]);
