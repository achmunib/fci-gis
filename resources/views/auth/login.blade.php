...
<style>
    .container > .row.justify-content-center {
            background-color: #f0f0f0; /* Mengatur warna background */
            background-image: url('{{ asset('img/bg_4.png') }}'); /* Mengatur gambar background */
            ...
            padding: 200px; /* Mengatur padding agar konten tidak menempel ke tepi */
            border-radius: 10px; /* Opsional: Mengatur sudut membulat */
        }
